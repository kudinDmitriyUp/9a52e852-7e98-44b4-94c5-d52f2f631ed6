...
export const metadata: Metadata = {
  title: "Grand Haven Hotel - Luxury Accommodations & Exceptional Service",
  description: "Experience unparalleled luxury at Grand Haven Hotel. World-class amenities, elegant rooms, fine dining, and exceptional hospitality await.",
  keywords: "luxury hotel, accommodation, hospitality, fine dining, spa, business travel, weekend getaway",
  metadataBase: new URL("https://grandhaven.com"),
  alternates: {
    canonical: "https://grandhaven.com"
  },
  openGraph: {
    ...
    url: "https://grandhaven.com",
    siteName: "Grand Haven Hotel",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763297506993-c3fuem6q.jpg",
  ...
  twitter: {
    ...
    title: "Grand Haven Hotel - Luxury Accommodations",
    description: "Experience unparalleled luxury at Grand Haven Hotel",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763297506993-c3fuem6q.jpg"]
  },
  robots: {
    index: true,
    follow: true
